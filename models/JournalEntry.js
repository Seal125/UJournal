...
class JournalEntry {
  static add(userId, title, entryBody) {
    const queryText = 'INSERT INTO journal_entries (user_id, title, entry_body) VALUES ($1, $2, $3);';
    return db.query(queryText, [userId, title, entryBody]);
  }
